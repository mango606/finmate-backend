...
public class LoginController {
    ...
    @ApiOperation(value = "로그아웃", notes = "현재 로그인한 사용자를 로그아웃하고 토큰을 비활성화합니다.")
    @PostMapping("/logout")
